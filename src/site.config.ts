...
const config: SiteConfig = {
  ...
  description:
    'Personal Blog of Simeon Nedkov',
  ...
  socialLinks: {
    github: 'https://github.com/simonen',
//    mastodon: 'https://github.com/stelcodes/multiterm-astro',
    email: 'si.nedkov@gmail.com',
    linkedin: 'https://github.com/simonen',
    bluesky: 'https://github.com/simonen',
    twitter: 'https://github.com/simonen',
